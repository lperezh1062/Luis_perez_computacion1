...
function Limpiar() {
  ...
  var formulario = hojaActiva.getSheetByName("Formulario"); // Aqui se escribe el nombre de la hoja donde se encuentra tu Formulario.

  var celdasALimpiar = ["B3", "B6", "B8", "B10", "D6", "D8", "D10"]; // Celdas a limpiar, muestra la ubicación de las celdas que deseas limpiar.
